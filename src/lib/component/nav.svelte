...
<header class="mx-10 mt-5">
	...
	{#if $showWarning}
		<div
			class="fixed top-10 inset-x-0.5 z-10 container alert alert-warning shadow-lg max-w-sm mx-auto rounded-box flex justify-center animate-bounce"
		>
			<svg
				xmlns="http://www.w3.org/2000/svg"
				fill="none"
	...
	{#if $successWarning}
		<div
			class="fixed top-10 inset-x-0.5 z-10 container alert alert-success shadow-lg max-w-xs mx-auto mb-2 rounded-box flex justify-center animate-bounce"
		>
			<svg
				xmlns="http://www.w3.org/2000/svg"
